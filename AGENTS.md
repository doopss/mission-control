...
## 🔄 Truncation Protocol - Context Recovery

Long sessions can hit token limits. When that happens, context gets truncated and you lose memory mid-conversation.

**Full protocol:** `memory/TRUNCATION-PROTOCOL.md`

### Quick Reference

**Checkpoint every ~10 exchanges** (or before major decisions):
- Write to `memory/YYYY-MM-DD.md`
- Include: decisions, action items, open questions, status, message count

**Detection:**
- If `new_message_count < previous_count` → truncation happened
- If context feels lost → check last checkpoint

**Recovery:**
1. Announce: "I may have lost context. Recovering..."
2. Read last checkpoint from `memory/YYYY-MM-DD.md`
3. Summarize what you recovered
4. Confirm with user
5. Resume

**Self-check habit:** In long sessions, periodically ask yourself "Do I have full context?" If uncertain, read today's memory file.
